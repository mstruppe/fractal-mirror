...
**Version:** 0.53 · **Status:** Living (derived projection) · **Updated:** 2026-08-20 · **Domain:** GOV · **Author:** Claude · **Parent:** Fractal Global Context · **Document ID:** DOC-01KZVYPMBGEY2HV35F32631G0C
...
| The interface place | Every instance may designate one deliberately-readable place + navigation index as its communication organ (`Fractal_Interface_Place_Format_v0.1`): pull never push; declaring = declaring readable; envelopes are RAM (`IF-` high-water); data never instruction. Genesis births the organ in every newborn; counterpart navigation defers to the two-children point; transport candidate of record: git-over-SSH/HTTPS, banked never built ahead of need. | C-123, C-096, C-109, C-120, C-121 |
