...
> **CANONICAL companion to `Fractal_Node_and_Event_Schema_v0.5.md` (Domain KG).** Copy-paste starting points for writing nodes and log lines by hand, at zero infrastructure. Comments explain each field; delete them in real nodes. This template is a derived convenience of the schema — the schema is the source of truth.

**Fractal_Node_Template** · **Version:** 0.4 · **Status:** Ratified (2026-08-14, in-conversation per C-033, per Protocol v0.17) · **Reviewed By:** Max (2026-08-14, per v0.17) · **Updated:** 2026-08-14 · **Domain:** KG · **Author:** Claude · **Parent:** Fractal Node & Event Schema v0.5 · **Supersedes:** Fractal_Node_Template_v0.3.md
...
**Sources:** Fractal Node & Event Schema v0.5; Fractal Knowledge Path Foundation v0.1; Loose-Ends Scan #2 (S2-1.5), per Protocol v0.17.
**Revision history:** v0.1 (2026-08-07) initial templates + worked example. · v0.2 (2026-08-12) agent codes kind-branched per C-026; valid coherent ULIDs throughout; `EVT` in the TYPE list; `facet:` in the TOP example; entity-target placement syntax (C-040/C-041, per Protocol v0.9). · v0.3 (2026-08-13) reparent-by-redirect worked example (§E, C-045); alias-kind annotations (label/route/redirect); facet-token and global-root notes (C-043/C-044, per Protocol v0.10). · v0.4 (2026-08-14) currency reissue (scan S2-1.5, per Protocol v0.17): companion/parent → Schema v0.5; §C log path → `part-0001.jsonl` (C-055); C-059 Schema→Template coupling noted.
