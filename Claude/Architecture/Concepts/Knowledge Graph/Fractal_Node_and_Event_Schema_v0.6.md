...
**Fractal_Node_and_Event_Schema** · **Version:** 0.6 · **Status:** Ratified (2026-08-14, in-conversation per C-033) · **Updated:** 2026-08-14 · **Domain:** KG · **Author:** Claude · **Parent:** Fractal Knowledge Path Foundation v0.1 · **Supersedes:** Fractal_Node_and_Event_Schema_v0.5.md · **Companion:** Fractal Navigation Contract v0.1 (read side, C-070)

**Decision status legend:** *Principle* (accepted, load-bearing) · *Working Decision* (accepted) · *Deferred* · *TBD*.

> **Why v0.6 exists (version-bump discipline, C-040).** Two registrations, **no format change**. (1) The read side of the system now has its own canonical contract — `Fractal_Navigation_Contract_v0.1.md` (C-070): the Schema fixes what is *written*, the Contract fixes how it is *read* (entry, hops, trace, ranking, history); the two cross-link here and refresh independently, so read-contract churn never forces a Schema reissue. (2) The standing note from the 2026-08-14 Return Package is discharged: the C-061 spec-version identity treatment is now documented in the spec's own text (§2.2). **C-059 Schema→Template coupling checked at this reissue: Template v0.4 unchanged** — no front-matter field, verb, or allocation rule moved.
...
**Sources:** Fractal Knowledge Path Foundation v0.1; Fractal Node & Event Schema v0.1–v0.5 (superseded); Fractal Navigation Contract v0.1 (companion, C-070); Governance Protocol — Claude v0.4, v0.6, v0.8–v0.10, v0.13, v0.15 & v0.19 (C-061); Decision Register (stamp inside, C-012); this conversation (2026-08-14, KG navigation architecture — Max's calls: entry as query shape, weight-product ranking, dedicated contract doc with Schema linking).
